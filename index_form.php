            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-heading">
                        <h2 class="">Кадрове агенство</h2>
                        <h3 class="agency">«King of Work»</h3>
                    </div>
                </div>
            </div>
            <div class="row">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="row">
					       <div class="col-lg-12 text-center">
                                <h2 class="">Порядок підбору персоналу</h2>
                            </div>
                        </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
                            ...
                            <div class="row">
					       <div class="col-lg-12 section-heading text-center">
                                <h2 class="wow fadeInUp">Чому саме ми?</h2>
                            </div>
                        </div>
